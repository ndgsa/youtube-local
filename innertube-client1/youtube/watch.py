...
def get_watch_page(video_id=None):
    ...
    if video_height > video_width: video_height,video_width = video_width,video_height
    # if (video_height == 360) and (video_height == video_width): video_height, video_width = 360, 640
    if abs(video_height - video_width) < 40: video_height, video_width = 360, 640
