...
# static_url_path='', # mine - this generates error if assets not in project folder
static_folder='../../assets/static', # mine - use static from innertube fork
template_folder='../../assets/templates') # mine - use templates from innertube fork
