...
## Warning! If use older versions please install new version on different path. Migrate `data` folder from `./old-youtube-local-path/assets/data/` to `./new-youtube-local-path/data/`. Also copy `settings.txt`. <br/>
